...
import 'package:flutter_web_socket/page/utils/janus_client/Plugin.dart';
...
class JanusClient {
  ...
  late bool _usingRest;
  late String _currentJanusUri;
  ...
  bool isUnifiedPlan;
  late int _sessionId;
  late void Function(int sessionId) _onSuccess;
  late void Function(dynamic) _onError;
  Uuid _uuid = Uuid();
  ...
  late Stream<dynamic> _webSocketStream;
